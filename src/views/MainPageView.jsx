  ...
  return (
    <div className="container-xl mt-5">
      <h4 className="d-flex align-items-center gap-3">
        <FaBitcoin />
        <span>Welcome to Coin List</span>
      </h4>

      <p>
        Coin List lists cryptocurrencies and digital coins from around the
        world. An excellent resource for tracking assets
      </p>
      ...
      <div className="d-flex my-5 justify-content-center">
        <button onClick={() => setPage(page => page + 1)} class="button2">
          More
        </button>
      </div>
    </div>
